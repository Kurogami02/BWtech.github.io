<?php
    ...
    $action = $_POST["action"];
    if($action == "dathang"){
        $_SESSION["giohang"][$_GET["masp"]] = $_GET["masp"];
...
<body>
    <div class="main">
        ...
        <form action="" method="post">
                <div class="concept-laptop">
                    <?php
                        $sql = "SELECT * FROM sanpham WHERE id=' ". $_GET["masp"] . "' ";
                    ...
                    ?>
                        <div class="concept-laptop-left"><img class="concept-laptop-img" src="<?php echo $row["anh"]; ?>" alt=""></div>
                            <div class="concept-laptop-right">
                                    <div class="concept-laptop-name"><?php echo $row["tensp"]; ?></div>
                                    <div class="concept-laptop-about"><strong>Mô tả: </strong><?php echo $row["mota"]; ?>
                                    <br><br><h3 class="discount">Khuyến mãi: </h3>
                                    </div>
                                    <span class="concept-laptop-pr1">Giá cả:</span> <span class="concept-laptop-pr"><?php echo $row["gia"]; ?></span>
                                    <div class="concept-laptop-button"><button name="action" value="dathang">Đặt hàng</button></div>
                            </div>
                                <?php }?>
                    <?php }?>
                </div>
