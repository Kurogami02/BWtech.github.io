...
?>
<?php
    $sql = "SELECT * FROM sanpham WHERE loai='laptop' LIMIT 8";
    ...
    <div class="main">
        <div class="main-box">
            <div class="header">
                ...
                <div class="sign">
                    <ul>
                        <?php if(!isset($_SESSION["ttnd"])) $_SESSION["ttnd"] = "test" ?>
        ...
        <div class="container">
            <div class="slider">
                <div class="slider-left">
                    <img src="./assets/img/slide1.png" onclick="slider()" id="pro">
                </div>
                <div class="slider-right">
                    <div class="slider1">
                        <div class="banner-top">
                            <a href=""><img src="./assets/img/bn1.png" alt=""></a>
                        </div>
                        <div class="banner-bottom">
                            <a href=""><img src="./assets/img/bn2.png" alt=""></a>
                        </div>
                    </div>
                    <div class="slider2">
                        <div class="banner-top">
                            <a href=""><img src="./assets/img/bn33.png" alt=""></a>
                        </div>
                        <div class="banner-bottom">
                            <a href=""><img src="./assets/img/bn5.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content2">
                <div class="content-title2">
                    <h1>Điện thoại thông minh giá không rẻ</h1>
                </div>
                <div class="content-pro">
                    <?php
                        $sql = "SELECT * FROM sanpham WHERE loai='phone' LIMIT 8";
                        $query=mysqli_query($conn,$sql);
                        $rowcount=mysqli_num_rows($query);
                        if($rowcount <= 0){
                        }else{
                    ...
                    ?>
                        <div class="out" >
                            <a href="product.php?masp=<?php echo $row["id"]; ?>">
                                <img class="outphone" src="<?php echo $row["anh"]; ?>" alt="">
                                <div class="outname"><?php echo $row["tensp"]; ?></div>
                                <div class="outpr"><?php echo $row["gia"]; ?></div>
                            </a>
                        </div>
